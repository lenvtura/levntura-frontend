    ...
    >
      <div className="md:max-w-1/3">
        <p className="typography-R16 leading-5 text-lev-black opacity-50">
          ...
          want to share feedback, or simply want to say hello, we’d love to hear
          from you. Get in touch with us using any of the following methods:
        </p>
      </div>
