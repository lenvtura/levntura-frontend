...
// Rendered by blogs-client.tsx (client) so this stays client too. next-intl
// reads locale + messages from the NextIntlClientProvider in the root layout.
export function BecomePartOfConversation() {
  const t = useTranslations("common.inspireOthers");
  return (
