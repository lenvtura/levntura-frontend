...
import { motion, Transition, easeOut } from "motion/react";
...
const fadeUpAnimation = (transition?: Transition) => ({
  ...
  // `easeOut` imported as a function (vs the string "easeOut") — motion
  // v12+ tightened its TS types and no longer accepts the string form.
